...
const titleFrames = [
  ...
  { text: title, topColor: colors.white, bottomColor: colors.magenta },
  { text: title, topColor: colors.magenta, bottomColor: colors.magenta },
  { text: title, topColor: colors.magenta, bottomColor: colors.white },
];
